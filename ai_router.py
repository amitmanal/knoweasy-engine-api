...
from providers.manager import generate_json as _manager_generate_json
...
def generate_json(prompt: str) -> Dict[str, Any]:
    """
    Backward-compatible entrypoint used by orchestrator.

    Track-B: routing is handled by providers.manager while preserving
    existing request implementations (_gemini_request/_openai_request/_claude_request).
    """
    return _manager_generate_json(prompt)
