...
GEMINI_LITE_MODEL = _env("GEMINI_LITE_MODEL", _env("GEMINI_FLASH_LITE_MODEL", "gemini-2.5-flash-lite"))
GEMINI_MASTERY_MODEL = _env("GEMINI_MASTERY_MODEL", _env("GEMINI_PRO_MODEL", "gemini-2.5-pro"))
...
OPENAI_VERIFIER_MODEL = _env("OPENAI_VERIFIER_MODEL", "o3-mini")

# Claude (future)
CLAUDE_API_KEY = _env("CLAUDE_API_KEY", _env("ANTHROPIC_API_KEY", ""))
CLAUDE_MODEL = _env("CLAUDE_WRITER_MODEL", _env("CLAUDE_MODEL", _env("CLAUDE_PRIMARY_MODEL", "claude-3-5-sonnet-20241022")))
